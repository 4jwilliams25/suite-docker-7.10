...
class SugarFieldTagsearch extends SugarFieldBase
{
    ...
    public function setup($parentFieldArray, $vardef, $displayParams, $tabindex, $twopass = true)
    {
        ...
        $jsonTagKeys = json_encode(array_keys($tagList));
        $jsonTagValues = json_encode(array_values($tagList));
        ...
        $this->ss->assign('tagIds', $jsonTagKeys);
        $this->ss->assign('tagNames', $jsonTagValues);
